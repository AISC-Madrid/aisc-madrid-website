...
<head>
    ...
    <!-- Keywords (optional, not used heavily by Google anymore) -->
    <meta name="keywords"
        content="AISC Madrid, AI student group, Artificial Intelligence UC3M, AI talks, AI workshops, UC3M events, Student collective AI">

    <!-- Open Graph / Facebook -->
    <meta property="og:title" content="AISC Madrid - AI Student Collective at UC3M">
    <meta property="og:description"
        content="Artificial Intelligence talks, workshops, and events for students at UC3M. Join the AISC community in Madrid.">
    <meta property="og:image" content="<?= cdn('images/logos/PNG/AISC Logo Square.png') ?>">
    ...
    <meta name="twitter:description"
        content="Join Madrid's AI student movement at UC3M. Attend events, talks, and workshops on Artificial Intelligence.">
    <meta name="twitter:image" content="<?= cdn('images/logos/PNG/AISC Logo Square.png') ?>">
