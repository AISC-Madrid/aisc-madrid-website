  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
      <ul class="navbar-nav align-items-center">
        ...
        <!-- Log In Button -->
        <li class="nav-item">
          <a class="btn btn-custom my-2 my-lg-0 ms-lg-3" href="login.php" data-en="Log In" data-es="Inicia Sesión" role="button" title="Inicia sesión o regístrate">Inicia Sesión</a>
        </li>
