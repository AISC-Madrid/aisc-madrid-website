...
<!-- Registration closed message -->
     <div class="container text-center my-5">
        <h2 class="fw-bold mb-3 scroll-margin" style="color: var(--muted);" data-en="Event Closed" data-es="Evento Finalizado">Evento Finalizado</h2>
        <h4 class="fw-bold mb-3" style="color: var(--primary);"
        data-en="<?= htmlspecialchars($event['title_es']) ?> is already over!" data-es="<?= htmlspecialchars($event['title_es']) ?> ya ha finalizado!">
        <?= htmlspecialchars($event['title_es']) ?> ya ha finalizado!</h4>
        <div class="mx-auto mt-3 mb-4" style="width:60px; height:3px; background: var(--primary); border-radius:2px;"></div>
        <p class="text-muted" data-en="Join the newsletter to stay up to date with everything we do and not miss a thing." data-es="Únete a la newsletter para enterarte de todo lo que hacemos y no perderte nada.">
